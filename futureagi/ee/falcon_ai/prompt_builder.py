class PromptBuilder:
    ...
    def _tools(self, tools):
        ...
        return (
            ...
            "\n"
            "Eval types. Create agent evals unless the user asks for another type:\n"
            "- 'agent' (default): Uses an AI agent with tools to evaluate. "
            "Omit eval_type on create_eval_template to get this.\n"
            ...
            "Only when the user explicitly asks for an LLM eval. "
            "Use create_eval_template with eval_type='llm'.\n"
            "\n"
            "Composite evals:\n"
